...
class TextCNN(object):
    def __init__(self, sequence_length, num_classes, index_to_embedding, filter_sizes, num_filters, l2_reg_lambda=0.0):
        ...
        with tf.name_scope('dense'):
            ...
            self.h_dense_sentiment = tf.concat([self.h_dense, self.input_sentiment],1) 
        ...
        with tf.name_scope("output"):
            ...
            self.scores = tf.nn.xw_plus_b(self.h_dense_sentiment, W, b, name="scores")
...
def train(x_train, y_train, x_dev, y_dev, dev_sentence_embedding):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "model/sentiment_cnn_noatt_nonstatic_runs", timestamp))
            print("Writing to {}\n".format(out_dir))
